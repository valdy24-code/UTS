...
MySQL - 10.4.17-MariaDB : Database - db_sekolah
*********************************************************************
*/
...
CREATE TABLE `tbl_pembayaran` (
  ...
  CONSTRAINT `tbl_pembayaran_ibfk_4` FOREIGN KEY (`id_spp`) REFERENCES `tbl_siswa` (`id_spp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('100000001',14197001,'Muhamad Novaldy Wiradharma',3001,'Komplek Kehutanan Muarasari RT 01 RW 03','6281383085729',102021);
